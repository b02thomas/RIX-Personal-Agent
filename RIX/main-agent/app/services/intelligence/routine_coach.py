...
from app.models.schemas import IntelligenceResponse, RoutineCoachingResponse
...
class RoutineCoachingService:
    ...
    async def get_coaching_insights(
        self, user_id: str, routine_id: str, recent_completion: Optional[Dict[str, Any]] = None
        ...
        try:
            ...
            if not routine:
                return RoutineCoachingResponse(success=False, data={}, insights={"error": "Routine not found"})
            ...
            coaching_message = self._generate_coaching_message(routine, streak_info, patterns, recent_completion)
            ...
            return RoutineCoachingResponse(success=False, data={}, insights={"error": str(e)})
    ...
    def _generate_coaching_message(
        ...
        recent_completion: Optional[Dict[str, Any]],
    ) -> str:
    ...
    def _generate_recommendations(
        self, routine: Dict[str, Any], patterns: Dict[str, Any], streak_info: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
