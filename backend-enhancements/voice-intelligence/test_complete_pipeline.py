...
async def test_entity_extractor():
    ...
    try:
        ...
        test_cases = [
            ...
            {
                "text": "Routine heute abends für 30 Minuten",
                "language": "de",
                "expected_types": ["date", "time", "duration"]
            },
            ...
            {
                "text": "Routine tonight for 45 minutes",
                "language": "en",
                "expected_types": ["time", "duration"]
            }
        ]
...
async def test_mcp_router():
    ...
    try:
        from voice_mcp_router import VoiceMCPRouter, MCPRequest, MCPEndpoint
        ...
        try:
            ...
            response = await router.route_voice_intent(
                mock_intent_result,
                user_id="test_user",
