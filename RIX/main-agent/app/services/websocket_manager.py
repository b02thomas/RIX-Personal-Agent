...
from app.models.chat import WebSocketMessage, TypingIndicator
    ...
    async def connect(self, websocket: WebSocket, user_id: str):
        ...
        await self.send_personal_message(
            json.dumps({
                ...
                "data": {
                    "message": "Connected to RIX Main Agent",
...
class WebSocketManager:
    ...
    async def send_processing_status(self, user_id: str, conversation_id: str, status: str, metadata: Optional[Dict[str, Any]] = None):
