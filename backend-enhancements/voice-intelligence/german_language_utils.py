...
class GermanLanguageUtils:
    ...
    def _initialize_cultural_markers(self) -> Dict[str, List[str]]:
        ...
        return {
            "formality_high": [
                "sie", "ihnen", "ihr", "ihre", "bitte schön", "sehr gerne", 
                "dürfte ich", "könnten sie", "würden sie", "haben sie die güte"
            ],
            "formality_low": [
                "du", "dir", "dich", "dein", "deine", "hey", "hi", "tschüss", 
                "mach mal", "kannst du", "magst du"
            ],
            "politeness_markers": [
                "bitte", "danke", "entschuldigung", "entschuldigen sie", 
                "verzeihen sie", "tut mir leid", "dankeschön", "vielen dank"
            ],
            "urgency_markers": [
                "sofort", "dringend", "eilig", "schnell", "asap", "unverzüglich",
                "umgehend", "sofortiger bedarf", "höchste priorität"
            ],
            "uncertainty_markers": [
                "vielleicht", "möglicherweise", "eventuell", "wahrscheinlich",
                "ich denke", "ich glaube", "ich meine", "vermutlich"
            ],
        }
    ...
    async def _fix_transcription_errors(self, text: str) -> str:
        ...
        corrections = {
            ...
            "dass": "das", "weiss": "weiß", "heiss": "heiß",
            "grosse": "große", "strasse": "straße",
            
            # Articles
            "dass": "das", "denn": "den", "dem": "dem",
            
            # Time expressions
            "heute": "heute", "morgen": "morgen", "gestern": "gestern",
            "naechste": "nächste", "letzte": "letzte",
            
            # Common verbs
            "machen": "machen", "gehen": "gehen", "kommen": "kommen",
            "haben": "haben", "sein": "sein", "werden": "werden",
        }
    ...
    async def has_german_characteristics(self, text: str) -> bool:
        ...
        try:
            ...
            # Common German words
            german_words = [
                'der', 'die', 'das', 'und', 'ist', 'ich', 'mit', 'für', 'auf',
                'eine', 'zu', 'haben', 'werden', 'können', 'soll', 'aber',
                'wie', 'was', 'wenn', 'oder', 'auch', 'noch', 'nach', 'über'
            ]
